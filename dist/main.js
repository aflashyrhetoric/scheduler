...
/*!**************************!*\
  !*** ./src/timeslots.js ***!
  \**************************/
/*! exports provided: TimeSlot, default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"TimeSlot\", function() { return TimeSlot; });\n/* harmony import */ var _Time__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Time */ \"./src/Time.js\");\n/* harmony import */ var _functions__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./functions */ \"./src/functions.js\");\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nfunction _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }\n\nfunction _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); return Constructor; }\n\n\n\nvar TimeSlot =\n/*#__PURE__*/\nfunction () {\n  function TimeSlot(startHour, startMinute) {\n    var day = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 'template';\n\n    _classCallCheck(this, TimeSlot);\n\n    this.day = day;\n    this.startTime = new _Time__WEBPACK_IMPORTED_MODULE_0__[\"default\"](startHour, startMinute);\n\n    if (startMinute + 30 >= 60) {\n      this.endTime = new _Time__WEBPACK_IMPORTED_MODULE_0__[\"default\"](startHour + 1, (startMinute + 30) % 60);\n    } else {\n      this.endTime = new _Time__WEBPACK_IMPORTED_MODULE_0__[\"default\"](startHour, startMinute + 30);\n    }\n\n    this.toString = function () {\n      return \"\".concat(Object(_functions__WEBPACK_IMPORTED_MODULE_1__[\"pp\"])(this.startTime), \" - \").concat(Object(_functions__WEBPACK_IMPORTED_MODULE_1__[\"pp\"])(this.endTime));\n    };\n  }\n\n  _createClass(TimeSlot, null, [{\n    key: \"allSlots\",\n    value: function allSlots() {\n      return [new TimeSlot(8, 0), new TimeSlot(8, 30), new TimeSlot(9, 0), new TimeSlot(9, 30), new TimeSlot(10, 0), new TimeSlot(10, 30), new TimeSlot(11, 0), new TimeSlot(11, 30), new TimeSlot(12, 0), new TimeSlot(12, 30), new TimeSlot(13, 0), new TimeSlot(13, 30), new TimeSlot(14, 0), new TimeSlot(14, 30), new TimeSlot(15, 0)];\n    }\n  }]);\n\n  return TimeSlot;\n}();\nvar timeslots = [new TimeSlot(8, 0, 'Thursday'), new TimeSlot(8, 30, 'Thursday'), new TimeSlot(9, 0, 'Thursday'), new TimeSlot(9, 30, 'Thursday'), new TimeSlot(10, 0, 'Thursday'), new TimeSlot(10, 30, 'Thursday'), new TimeSlot(11, 0, 'Thursday'), new TimeSlot(11, 30, 'Thursday'), new TimeSlot(12, 0, 'Thursday'), new TimeSlot(12, 30, 'Thursday'), new TimeSlot(13, 0, 'Thursday'), new TimeSlot(13, 30, 'Thursday'), new TimeSlot(14, 0, 'Thursday'), new TimeSlot(14, 30, 'Thursday'), new TimeSlot(15, 0, 'Thursday'), new TimeSlot(8, 0, 'Friday'), new TimeSlot(8, 30, 'Friday'), new TimeSlot(9, 0, 'Friday'), new TimeSlot(9, 30, 'Friday'), new TimeSlot(10, 0, 'Friday'), new TimeSlot(10, 30, 'Friday'), new TimeSlot(11, 0, 'Friday'), new TimeSlot(11, 30, 'Friday'), new TimeSlot(12, 0, 'Friday'), new TimeSlot(12, 30, 'Friday'), new TimeSlot(13, 0, 'Friday'), new TimeSlot(13, 30, 'Friday'), new TimeSlot(14, 0, 'Friday'), new TimeSlot(14, 30, 'Friday'), new TimeSlot(15, 0, 'Friday')];\n/* harmony default export */ __webpack_exports__[\"default\"] = (timeslots);\n\n//# sourceURL=webpack:///./src/timeslots.js?");
