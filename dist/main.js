...
/******/ 	// eslint-disable-next-line no-unused-vars
/******/ 	var hotCurrentHash = "3b0db98ef77a078c1309";
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nfunction _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }\n\nfunction _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); return Constructor; }\n\nvar Time =\n/*#__PURE__*/\nfunction () {\n  function Time(hours, minutes) {\n    _classCallCheck(this, Time);\n\n    this.hours = hours;\n    this.minutes = minutes;\n  }\n\n  _createClass(Time, [{\n    key: \"convertToSeconds\",\n    value: function convertToSeconds() {\n      var seconds = 0;\n      seconds += this.hours * 60\n      /* minutes */\n      * 60\n      /* seconds */\n      ;\n      seconds += this.minutes * 60\n      /* seconds */\n      ;\n      return seconds;\n    }\n  }]);\n\n  return Time;\n}();\n\nfunction pp(time) {\n  var AMPM = time.hours < 12 ? 'AM' : 'PM';\n  var displayHours = time.hours > 12 ? time.hours % 12 : time.hours;\n\n  if (time.minutes == 0) {\n    time.minutes = '00';\n  }\n\n  return \"\".concat(displayHours, \":\").concat(time.minutes).concat(AMPM);\n}\n\nvar TimeSlot = function TimeSlot(startHour, startMinute) {\n  _classCallCheck(this, TimeSlot);\n\n  this.startTime = new Time(startHour, startMinute);\n\n  if (startMinute + 30 >= 60) {\n    this.endTime = new Time(startHour + 1, (startMinute + 30) % 60);\n  } else {\n    this.endTime = new Time(startHour, startMinute + 30);\n  }\n\n  this.toString = function () {\n    return \"\".concat(pp(this.startTime), \" - \").concat(pp(this.endTime));\n  };\n};\n\nvar timeslots = [new TimeSlot(8, 0), new TimeSlot(8, 30), new TimeSlot(9, 0), new TimeSlot(9, 30), new TimeSlot(10, 0), new TimeSlot(10, 30), new TimeSlot(11, 0), new TimeSlot(11, 30), new TimeSlot(12, 0), new TimeSlot(12, 30), new TimeSlot(13, 0), new TimeSlot(13, 30), new TimeSlot(14, 0), new TimeSlot(14, 30), new TimeSlot(15, 0)];\n/* harmony default export */ __webpack_exports__[\"default\"] = (timeslots);\n\n//# sourceURL=webpack:///./src/timeslots.js?");
